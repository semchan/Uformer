...
def get_parser():# -> argparse.ArgumentParser:
    ...
    parser.add_argument('--splits', type=str, nargs='+',default=['./splits/tvsum.yml','./splits/summe.yml'])


    parser.add_argument('--max-epoch', type=int, default=300)

    parser.add_argument('--model-dir', type=str, default='./models/ab_basic/')
    ...
    parser.add_argument('--anchor-scales', type=int, nargs='+',
                        default=[4, 8, 16, 32,64,128,512])



    parser.add_argument('--lambda-ctr', type=float, default=5.0)
